...
exports('ShowAdvancedNotification', (title, subTitle, dict, icon, duration, color) => {
	...
	struct2.setBigInt64(48, BigInt(GetHashKey(color)), true);
...
exports('ShowSimpleCenterText', (text, duration, color) => {
	...
	const struct2 = new DataView(new ArrayBuffer(24));
	struct2.setBigInt64(8, BigInt(string), true);
	struct2.setBigInt64(16, BigInt(GetHashKey(color)), true);
